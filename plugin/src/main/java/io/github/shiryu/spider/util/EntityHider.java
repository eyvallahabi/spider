...
public class EntityHider implements Listener {
    ...
    // Packets that update remote player entities (updated for 1.21.5)
    private static final PacketType[] ENTITY_PACKETS = { 
            PacketType.Play.Server.ENTITY_EQUIPMENT,
            PacketType.Play.Server.ENTITY_LOOK, // Renamed from ENTITY_LOOK
            PacketType.Play.Server.COLLECT,
            PacketType.Play.Server.SPAWN_ENTITY, // Consolidated spawn packet
            PacketType.Play.Server.EXPERIENCE, // Renamed from EXPERIENCE
            ...
            PacketType.Play.Server.MOUNT // Replaces ATTACH_ENTITY
            // VEHICLE_MOVE, SPAWN_ENTITY_PAINTING, SPAWN_ENTITY_EXPERIENCE_ORB removed/consolidated
            // We don't handle ENTITY_DESTROY though
    };
    ...
    public final boolean showEntity(Player observer, Entity entity) {
        ...
        if (manager != null && hiddenBefore)
            manager.updateEntity(entity, List.of(observer));
    ...
    public final boolean hideEntity(Player observer, Entity entity) {
        ...
        if (visibleBefore) {
            ...
            this.manager.sendServerPacket(observer, packet);
        }
